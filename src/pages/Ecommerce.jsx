              ...
              <div className= "bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
                ...
                <div className='mt-10 flex gap-10 flex-wrap justify-center'>
                  <div className= "border-r-1 border-color m-4 pr-10">
                    <div>
                      <p>
                        <span className='text-3xl font-semibold'>$ 93131</span>
                        <span className='p-1.5 hover:drop-shadow-xl cursor-pointer bg-green-400 rounded-xl text-xs text-white ml-3'>23%</span>
                      </p>
                    ...
                    <div className='mt-10 '>
                      <Button color="white"text="Download Report" bgColor="blue" borderRadius="10px"/>
                    </div>
                  </div>
